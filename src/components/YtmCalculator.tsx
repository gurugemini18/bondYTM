...
import { BondDetails, YtmResult, CouponFrequencyOptions, BondInputState } from '../types';
...
const YtmCalculator: React.FC<YtmCalculatorProps> = ({ bondInputs, setBondInputs }) => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        setBondInputs(prev => ({ ...prev, [name]: type === 'number' ? parseFloat(value) : value }));
    };
    ...
    const displayValues = useMemo(() => {
        ...
        const profit = (totalCouponPayments + maturityAmount) - amountToInvest;
        ...
        <div className="space-y-8">
            <div className="lg:grid lg:grid-cols-5 lg:gap-8 lg:items-start">
                ...
                <div className="lg:col-span-3 mt-6 lg:mt-0">
                    <div className="sticky top-24 bg-white dark:bg-night-card shadow-xl rounded-2xl p-6 space-y-4">
